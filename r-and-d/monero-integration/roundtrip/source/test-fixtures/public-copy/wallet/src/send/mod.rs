...
// Fixture-only public input; this package is never used as a production wallet.
pub(crate) fn fixture_public_point(name: &str) -> Option<crate::ed25519::Point> {
  ...
  Some(crate::ed25519::CompressedPoint::from(bytes).decompress().unwrap())
}
